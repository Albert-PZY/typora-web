...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "feature.callout": "GitHub-style callouts: NOTE, TIP, IMPORTANT, WARNING, DANGER, and CAUTION.",
  ...
  zh: {
    ...
    "feature.callout": "GitHub 风格提示框：NOTE、TIP、IMPORTANT、WARNING、DANGER 和 CAUTION。",
