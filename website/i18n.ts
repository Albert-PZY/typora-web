...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "home.theme": "Theme",
    "home.themeTitle": "Import Typora Theme",
    "home.clearTheme": "Clear",
    "home.clearThemeTitle": "Clear Theme",
    ...
    "home.status.themeCleared": "Theme cleared",
    "home.status.themeApplied": "Theme {name}",
    ...
    "feature.html-block": "CommonMark HTML blocks rendered through DOMPurify.",
    ...
    "feature.code_block": "Fenced code blocks with language input.",
  ...
  zh: {
    ...
    "home.theme": "主题",
    "home.themeTitle": "导入 Typora 主题",
    "home.clearTheme": "清除",
    "home.clearThemeTitle": "清除主题",
    ...
    "home.status.themeCleared": "主题已清除",
    "home.status.themeApplied": "已应用主题 {name}",
    ...
    "feature.html-block": "通过 DOMPurify 消毒后渲染 CommonMark HTML 块。",
    ...
    "feature.code_block": "带语言输入的围栏代码块。",
