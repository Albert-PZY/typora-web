...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "home.status.folderOpened": "Opened folder {name}",
    "home.status.folderUnsupported": "Folder picker is not supported in this browser",
    "home.status.newDocument": "New untitled document",
    "home.status.closedDocument": "Closed document",
    "home.status.copied": "Copied to clipboard",
    "home.status.pasted": "Pasted plain text",
    "home.status.noSelection": "Select text first",
    "home.status.clipboardUnsupported": "Clipboard access is not available in this browser",
    "home.status.notImplemented": "This menu item is a compatibility placeholder",
    "home.confirm.discard": "Discard the current document?",
    "home.menu.file": "File",
    "home.menu.edit": "Edit",
    "home.menu.paragraph": "Paragraph",
    "home.menu.format": "Format",
    "home.menu.view": "View",
    "home.menu.new": "New",
    "home.menu.newWindow": "New Window",
    "home.menu.openFolder": "Open Folder",
    "home.menu.import": "Import",
    "home.menu.export": "Export",
    "home.menu.print": "Print",
    "home.menu.close": "Close",
    "home.menu.undo": "Undo",
    "home.menu.redo": "Redo",
    "home.menu.cut": "Cut",
    "home.menu.copy": "Copy",
    "home.menu.paste": "Paste",
    "home.menu.copyMarkdown": "Copy as Markdown",
    "home.menu.pasteText": "Paste as Plain Text",
    "home.menu.selectAll": "Select All",
    "home.menu.find": "Find and Replace",
    "home.menu.heading1": "Heading 1",
    "home.menu.heading2": "Heading 2",
    "home.menu.heading3": "Heading 3",
    "home.menu.paragraphText": "Paragraph",
    "home.menu.mathBlock": "Math Block",
    "home.menu.codeBlock": "Code Block",
    "home.menu.quote": "Quote",
    "home.menu.orderedList": "Ordered List",
    "home.menu.bulletList": "Unordered List",
    "home.menu.taskList": "Task List",
    "home.menu.bold": "Bold",
    "home.menu.italic": "Italic",
    "home.menu.underline": "Underline",
    "home.menu.inlineCode": "Code",
    "home.menu.inlineMath": "Inline Math",
    "home.menu.strike": "Strikethrough",
    "home.menu.highlight": "Highlight",
    "home.menu.link": "Hyperlink",
    "home.menu.image": "Image",
    "home.menu.clearStyle": "Clear Style",
    "home.menu.sidebar": "Show / Hide Sidebar",
    "home.menu.outline": "Outline",
    "home.menu.fileTree": "File Tree",
    "home.menu.search": "Search",
    "home.menu.source": "Source Code Mode",
    "home.menu.statusbar": "Show Status Bar",
    "home.menu.fullscreen": "Toggle Full Screen",
    "home.sidebar.files": "Files",
    "home.sidebar.outline": "Outline",
    "home.sidebar.emptyOutline": "No headings yet",
    "home.stats.words": "{count} words",
    "home.stats.title": "Word Count",
    "home.stats.minutes": "minutes",
    "home.stats.lines": "lines",
    "home.stats.wordsLabel": "words",
    "home.stats.characters": "characters",
    "home.search.findLabel": "Find",
    "home.search.findPlaceholder": "Find",
    "home.search.replaceLabel": "Replace with",
    "home.search.replacePlaceholder": "Replace with",
    "home.search.previous": "Previous match",
    "home.search.next": "Next match",
    "home.search.replace": "Replace",
    "home.search.replaceAll": "Replace All",
    "home.search.close": "Close search",
    "home.search.noResults": "No results",
    "home.search.position": "{current} / {count}",
    "home.search.replaced": "Replaced {count}",
    ...
    "feature.html-block": "CommonMark HTML blocks render as sanitized previews with source reveal.",
    "feature.heading": "ATX headings #..######, with sticky draft state.",
    "feature.blockquote": "> quoted blocks, joined and split by Enter.",
    "feature.callout": "GitHub-style callouts: NOTE, TIP, IMPORTANT, WARNING, and DANGER.",
  ...
  zh: {
    ...
    "home.status.folderOpened": "已打开文件夹 {name}",
    "home.status.folderUnsupported": "当前浏览器不支持打开文件夹",
    "home.status.newDocument": "已新建无标题文档",
    "home.status.closedDocument": "已关闭文档",
    "home.status.copied": "已复制到剪贴板",
    "home.status.pasted": "已粘贴纯文本",
    "home.status.noSelection": "请先选择文本",
    "home.status.clipboardUnsupported": "当前浏览器无法访问剪贴板",
    "home.status.notImplemented": "此菜单项暂作为兼容占位",
    "home.confirm.discard": "放弃当前文档吗？",
    "home.menu.file": "文件",
    "home.menu.edit": "编辑",
    "home.menu.paragraph": "段落",
    "home.menu.format": "格式",
    "home.menu.view": "视图",
    "home.menu.new": "新建",
    "home.menu.newWindow": "新建窗口",
    "home.menu.openFolder": "打开文件夹",
    "home.menu.import": "导入",
    "home.menu.export": "导出",
    "home.menu.print": "打印",
    "home.menu.close": "关闭",
    ...
    "home.menu.copy": "复制",
    "home.menu.paste": "粘贴",
    "home.menu.copyMarkdown": "复制为 Markdown",
    "home.menu.pasteText": "粘贴为纯文本",
    "home.menu.selectAll": "选择全部",
    "home.menu.find": "查找和替换",
    "home.menu.heading1": "一级标题",
    "home.menu.heading2": "二级标题",
    "home.menu.heading3": "三级标题",
    "home.menu.paragraphText": "段落",
    "home.menu.mathBlock": "公式块",
    "home.menu.codeBlock": "代码块",
    "home.menu.quote": "引用",
    "home.menu.orderedList": "有序列表",
    "home.menu.bulletList": "无序列表",
    "home.menu.taskList": "任务列表",
    "home.menu.bold": "加粗",
    "home.menu.italic": "斜体",
    "home.menu.underline": "下划线",
    "home.menu.inlineCode": "代码",
    "home.menu.inlineMath": "内联公式",
    "home.menu.strike": "删除线",
    "home.menu.highlight": "高亮",
    "home.menu.link": "超链接",
    "home.menu.image": "图像",
    "home.menu.clearStyle": "清除样式",
    "home.menu.sidebar": "显示 / 隐藏侧边栏",
    "home.menu.outline": "大纲",
    "home.menu.fileTree": "文件树",
    "home.menu.search": "搜索",
    "home.menu.source": "源代码模式",
    "home.menu.statusbar": "显示状态栏",
    "home.menu.fullscreen": "切换全屏",
    "home.sidebar.files": "文件",
    "home.sidebar.outline": "大纲",
    "home.sidebar.emptyOutline": "暂无标题",
    "home.stats.words": "{count} 词",
    "home.stats.title": "字数统计",
    "home.stats.minutes": "分钟",
    "home.stats.lines": "行",
    "home.stats.wordsLabel": "词",
    "home.stats.characters": "字符",
    "home.search.findLabel": "查找",
    "home.search.findPlaceholder": "查找",
    "home.search.replaceLabel": "替换为",
    "home.search.replacePlaceholder": "替换为",
    "home.search.previous": "上一个匹配项",
    "home.search.next": "下一个匹配项",
    "home.search.replace": "替换",
    "home.search.replaceAll": "全部替换",
    "home.search.close": "关闭搜索",
    "home.search.noResults": "未找到结果",
    "home.search.position": "{current} / {count}",
    "home.search.replaced": "已替换 {count} 处",
    ...
    "feature.html-block": "CommonMark HTML 块会消毒后渲染预览，并可点击显示源码。",
    "feature.heading": "ATX 标题 # 到 ######，支持草稿态预览。",
    "feature.blockquote": "> 引用块，支持 Enter 合并和拆分。",
    "feature.callout": "GitHub 风格提示框：NOTE、TIP、IMPORTANT、WARNING 和 DANGER。",
